...
/***/ function(module, exports, __webpack_require__) {
	...
	var Testing = function (_Component) {
		...
		function Testing() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Testing).call(this));
		...
		_createClass(Testing, [{
			...
			value: function onEmojiClick(name) {
				console.log(name);
				var emojis = this.state.emojis.concat([{ name: name, count: 1 }]);
				this.setState({ emojis: emojis });
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(_dist2.default, {
	...
	(0, _reactDom.render)(_react2.default.createElement(Testing, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EmojiWrapper = exports.SingleEmoji = undefined;
	
	var _react = __webpack_require__(2);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _gemoji = __webpack_require__(159);
	...
	var SingleEmoji = exports.SingleEmoji = function (_Component) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						{ style: emojiStyle },
						_gemoji2.default.name[name].emoji
					),
					_react2.default.createElement(
						'span',
	...
	var EmojiWrapper = exports.EmojiWrapper = function EmojiWrapper(_ref) {
		var reactions = _ref.reactions;
		var onReaction = _ref.onReaction;
	
		return _react2.default.createElement(
			'div',
			{ style: { display: 'inline-block' } },
			reactions.map(function (_ref2) {
				var name = _ref2.name;
				...
				var emojis = Object.keys(_gemoji2.default.name).map(function (em) {
					return _react2.default.createElement(
						'span',
						{
							...
							key: em,
							onClick: function onClick() {
								return onEmojiClick(em);
							}
						},
						_gemoji2.default.name[em].emoji
					);
				});
				return _react2.default.createElement(
					'div',
		...
		_createClass(EmojiReact, [{
			...
			value: function render() {
				...
				var selector = _react2.default.createElement(
					...
					_react2.default.createElement(EmojiSelector, { showing: this.state.showSelector, onEmojiClick: onEmojiClick })
				);
				return _react2.default.createElement(
					'div',
